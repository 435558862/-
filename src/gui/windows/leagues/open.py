...
from PySide6.QtWidgets import QCheckBox, QComboBox, QDialog, QMessageBox, QPushButton, QVBoxLayout
    ...
    def _load_league(self):
        ...
        def update_and_load():
            if self._checkbox_update.isChecked():
                # Use the same complete path as Tools -> 同步全部联赛 so newly
                # recorded matches refit every saved model for this league.
                sync_five_leagues(league_ids=(league_id,), retrain_on_change=True)
